...
const file_payment_v1_payment_proto_rawDesc = "" +
	...
	"\x0fInitiatePayment\x12\".payment.v1.InitiatePaymentRequest\x1a#.payment.v1.InitiatePaymentResponseB=Z;github.com/ametowartem/orderflow/proto/payment/v1;paymentv1b\x06proto3"
...
var file_payment_v1_payment_proto_depIdxs = []int32{
	0, // 0: payment.v1.PaymentService.InitiatePayment:input_type -> payment.v1.InitiatePaymentRequest
	1, // 1: payment.v1.PaymentService.InitiatePayment:output_type -> payment.v1.InitiatePaymentResponse
